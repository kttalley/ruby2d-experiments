  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      Opal.defn(self, '$initialize', TMP_Window_initialize_27 = function $$initialize(args) {
        ...
        return (self.controller_mappings_path = Opal.const_get_relative($nesting, 'File').$join(Opal.const_get_relative($nesting, 'Dir').$home(), ".ruby2d", "controllers.txt"));
...
if (object == null) object = nil;
  ...
  (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Sprite_initialize_105, TMP_Sprite_start_106, TMP_Sprite_add_107, TMP_Sprite_animate_108, TMP_Sprite_reset_109, TMP_Sprite_remove_110, TMP_Sprite_width_111, TMP_Sprite_height_112, TMP_Sprite_clip_113, TMP_Sprite_animate_frames_114, TMP_Sprite_clip_with_current_frame_115;

      def.animations = def.current_animation = def["default"] = def.current_frame = def.current_frame_time = nil;
      ...
      Opal.defn(self, '$width', TMP_Sprite_width_111 = function $$width() {
        var self = this;

        if ($truthy(self.current_animation)) {
          return self.animations['$[]'](self.current_animation)['$[]'](self.current_frame)['$[]'](2)
          } else {
          return self["default"]['$[]'](2)
        }
      }, TMP_Sprite_width_111.$$arity = 0);
      
      Opal.defn(self, '$height', TMP_Sprite_height_112 = function $$height() {
        var self = this;

        if ($truthy(self.current_animation)) {
          return self.animations['$[]'](self.current_animation)['$[]'](self.current_frame)['$[]'](3)
          } else {
          return self["default"]['$[]'](3)
        }
      }, TMP_Sprite_height_112.$$arity = 0);
      self.$private();
      
      Opal.defn(self, '$clip', TMP_Sprite_clip_113 = function $$clip(x, y, w, h) {
        var $a, self = this;

        return $a = [x, y, w, h], (self.clip_x = $a[0]), (self.clip_y = $a[1]), (self.clip_w = $a[2]), (self.clip_h = $a[3]), $a
      }, TMP_Sprite_clip_113.$$arity = 4);
      
      Opal.defn(self, '$animate_frames', TMP_Sprite_animate_frames_114 = function $$animate_frames(frames) {
        var self = this;
      ...
      }, TMP_Sprite_animate_frames_114.$$arity = 1);
      return (Opal.defn(self, '$clip_with_current_frame', TMP_Sprite_clip_with_current_frame_115 = function $$clip_with_current_frame(frames) {
        var self = this;
      ...
      }, TMP_Sprite_clip_with_current_frame_115.$$arity = 1), nil) && 'clip_with_current_frame';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Text_initialize_116, TMP_Text_text$eq_117, TMP_Text_color$eq_118, TMP_Text_contains$q_119, TMP_Text_resolve_path_120;
      ...
      Opal.defn(self, '$initialize', TMP_Text_initialize_116 = function $$initialize(opts) {
        var $a, self = this, $writer = nil;
        ...
        self.$ext_init();
        return self.$add();
      }, TMP_Text_initialize_116.$$arity = -1);
      
      Opal.defn(self, '$text=', TMP_Text_text$eq_117 = function(msg) {
        var self = this;

        
        self.text = msg.$to_s();
        return self.$ext_set(self.text);
      }, TMP_Text_text$eq_117.$$arity = 1);
      
      Opal.defn(self, '$color=', TMP_Text_color$eq_118 = function(c) {
        var self = this;

        return (self.color = Opal.const_get_relative($nesting, 'Color').$new(c))
      }, TMP_Text_color$eq_118.$$arity = 1);
      
      Opal.defn(self, '$contains?', TMP_Text_contains$q_119 = function(x, y) {
        var $a, $b, $c, self = this;

        return ($truthy($a = ($truthy($b = ($truthy($c = $rb_lt(self.x, x)) ? $rb_gt($rb_plus(self.x, self.width), x) : $c)) ? $rb_lt(self.y, y) : $b)) ? $rb_gt($rb_plus(self.y, self.height), y) : $a)
      }, TMP_Text_contains$q_119.$$arity = 2);
      self.$private();
      return (Opal.defn(self, '$resolve_path', TMP_Text_resolve_path_120 = function $$resolve_path(font) {
      ...
      }, TMP_Text_resolve_path_120.$$arity = 1), nil) && 'resolve_path';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Sound_initialize_121, TMP_Sound_play_122;

      
      self.$attr_accessor("data");
      self.$attr_reader("path");
      
      Opal.defn(self, '$initialize', TMP_Sound_initialize_121 = function $$initialize(path) {
        var self = this;
      ...
      }, TMP_Sound_initialize_121.$$arity = 1);
      return (Opal.defn(self, '$play', TMP_Sound_play_122 = function $$play() {
        var self = this;

        return self.$ext_play()
      }, TMP_Sound_play_122.$$arity = 0), nil) && 'play';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
  (function($base, $parent_nesting) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Music_initialize_123, TMP_Music_play_124, TMP_Music_pause_125, TMP_Music_resume_126, TMP_Music_stop_127, TMP_Music_fadeout_128;

      
      self.$attr_accessor("data", "loop");
      self.$attr_reader("path");
      
      Opal.defn(self, '$initialize', TMP_Music_initialize_123 = function $$initialize(path) {
        var self = this;
        ...
        self.loop = false;
        return self.$ext_init(path);
      }, TMP_Music_initialize_123.$$arity = 1);
      
      Opal.defn(self, '$play', TMP_Music_play_124 = function $$play() {
        var self = this;

        return self.$ext_play()
      }, TMP_Music_play_124.$$arity = 0);
      
      Opal.defn(self, '$pause', TMP_Music_pause_125 = function $$pause() {
        var self = this;

        return self.$ext_pause()
      }, TMP_Music_pause_125.$$arity = 0);
      
      Opal.defn(self, '$resume', TMP_Music_resume_126 = function $$resume() {
        var self = this;

        return self.$ext_resume()
      }, TMP_Music_resume_126.$$arity = 0);
      
      Opal.defn(self, '$stop', TMP_Music_stop_127 = function $$stop() {
        var self = this;

        return self.$ext_stop()
      }, TMP_Music_stop_127.$$arity = 0);
      return (Opal.defn(self, '$fadeout', TMP_Music_fadeout_128 = function $$fadeout(ms) {
        var self = this;

        return self.$ext_fadeout(ms)
      }, TMP_Music_fadeout_128.$$arity = 1), nil) && 'fadeout';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, $send = Opal.send, square1 = nil, $writer = nil, square2 = nil;

  Opal.add_stubs(['$set', '$new', '$x=', '$-', '$size=', '$y=', '$color=', '$show']);
  
  self.$set($hash2(["title"], {"title": "ruby2d primities"}));
  Opal.const_get_relative($nesting, 'Square').$new($hash2(["x", "y", "size"], {"x": 100, "y": 100, "size": 150}));
  square1 = Opal.const_get_relative($nesting, 'Square').$new();
  
  $writer = [200];
  $send(square1, 'x=', Opal.to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  
  $writer = [350];
  $send(square1, 'size=', Opal.to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  square2 = Opal.const_get_relative($nesting, 'Square').$new();
  
  $writer = [400];
  $send(square2, 'x=', Opal.to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  
  $writer = [300];
  $send(square2, 'y=', Opal.to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  
  $writer = [100];
  $send(square2, 'size=', Opal.to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  
  $writer = ["red"];
  $send(square2, 'color=', Opal.to_a($writer));
  $writer[$rb_minus($writer["length"], 1)];;
  return self.$show();
})(Opal);
