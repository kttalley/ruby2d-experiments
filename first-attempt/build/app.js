...
(function(Opal) {
  ...
  Opal.add_stubs(['$set', '$new', '$show']);
  
  self.$set($hash2(["title"], {"title": "Hello Triangle"}));
  Opal.const_get_relative($nesting, 'Triangle').$new($hash2(["x1", "y1", "x2", "y2", "x3", "y3", "color"], {"x1": 320, "y1": 50, "x2": 540, "y2": 430, "x3": 100, "y3": 430, "color": ["red", "green", "blue"]}));
  return self.$show();
})(Opal);
